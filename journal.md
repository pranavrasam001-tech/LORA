...
# time spent:1.5hr
## description:
firstly i have decided to enlarge my hardware project which give me the best output of complexity to face n number of challenges in that project , so i have decided to make a LoRa Puck as it suits my energy, i have gone through lots of guides present there , searched for many components for a single component , i dint get a exact component but similar to it i have take the components in to the consideration and i have placed come of the components to start!
<img width="729" height="621" alt="image" src="https://github.com/user-attachments/assets/ff1ce385-bbf0-4a9f-9793-1f3806797300" />
